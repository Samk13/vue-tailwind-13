<template>
  <div class="container py-4 rounded-lg bg-teal-900 rounded-lg shadow-xl">
    <h1 class="text-4xl text-center my-5">select one:</h1>
    <SelectOneInline class="m-auto w-1/2" v-model="selected" :options="options"/>
    <div class="my-4 mx-auto md:w-1/2 text-center font-mono bg-teal-500 rounded-lg p-3">
      selected: {
      <span
        v-if="selected !== null "
